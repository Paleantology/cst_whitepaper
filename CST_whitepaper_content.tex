...
\sarah{This sentence has been fragmented}
...
\textbf{\centerline{Diversity and Inclusion call out box!}} 
\begin{snugshade*}
\sarah{This box is almost the same as the next box -- perhaps we should merge the two or delete one?}
...
\textbf{\centerline{Diversity and Inclusion call out box!}} 
\begin{snugshade*}
\sarah{As I noted above, this box is almost the same as the previous box -- perhaps we should merge the two or delete one?}
...
\sarah{I think we should make this a subsection not a subsubsection}
...
Universities in particular have the unspoken expectation that undergraduates will seek help when they need it, but people from lower-income backgrounds will not necessarily know this or may feel uncomfortable approaching their teachers, who are in positions of authority \citep{jack2016no}.
